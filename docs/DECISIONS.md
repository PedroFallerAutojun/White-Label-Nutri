...
| D-005 | — | Destino dos bugs B1–B14 (preservar comportamento vs corrigir) — decidir um a um na especificação da nova versão. | Corrigir |
| D-006 | — | Confirmar com o usuário: filtro de ingredientes ≥2024 (BR-017), %VD de selênio (B9), recálculo de fichas ao editar ingrediente (B13), escopo "white-label". | Manter |
